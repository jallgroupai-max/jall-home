...
import { Coins, Menu, MessageSquarePlus, Moon, Plus, Sun, X } from "lucide-react";
            ...
            <Tooltip delayDuration={0}>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  <span className="font-semibold text-sm text-foreground">{pointsLabel}</span>
            ...
            <div className="flex items-center justify-between px-3 py-2.5 bg-primary/10 border border-primary/20 rounded-2xl">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-bold text-sm text-foreground">{pointsLabel}</p>
                </div>
              </div>
              <Button
                onClick={onRecharge}
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`flex items-center gap-3 w-full px-3 py-2.5 rounded-xl transition-colors text-sm font-medium ${
                    activeTabId === tab.id ? "bg-primary/10 text-primary" : "text-foreground/80 hover:bg-secondary"
                  }`}
                >
                  <tab.icon className="w-4 h-4" />
                  {tab.label}
