...
export const translations = {
  es: {
    ...
    "hero.badge.freePoints": "150 puntos gratis",
    "hero.title": "Texto, imágenes, videos y voces con IA desde",
    "hero.pricePerDay": "$0.3/día",
    "hero.subtitle": "Usa ChatGPT, genera videos con inteligencia artificial y crea voces profesionales.",
    "hero.payInBs": "Paga en bolívares.",
    "hero.payInUsd": "Paga solo lo que uses.",
    "hero.createVideos": "Regístrate gratis y pruébalo ahora.",
    "hero.registerFree": "Empezar Gratis",
    ...
    // Benefits
    "benefits.title": "Todo lo que puedes hacer con",
    "benefits.titleHighlight": "Jall AI",
    "benefits.subtitle": "Herramientas profesionales de inteligencia artificial, fáciles de usar desde cualquier dispositivo.",
    "benefits.chatgpt.title": "Escribe y pregunta con ChatGPT",
    "benefits.chatgpt.desc": "Crea textos, responde preguntas, analiza documentos, genera imágenes y más. Como tener un asistente personal disponible las 24 horas.",
    "benefits.video.title": "Crea videos con inteligencia artificial",
    "benefits.video.desc": "Genera videos llamativos en segundos, ideales para redes sociales como TikTok, Instagram y YouTube.",
    "benefits.voice.title": "Genera voces profesionales",
    "benefits.voice.desc": "Convierte cualquier texto en una voz realista. Perfecto para videos, presentaciones y contenido profesional.",
    "benefits.payment.title": "Paga fácil en bolívares",
    "benefits.payment.desc": "Sin tarjeta internacional. Paga cómodo por transferencia, Pago Móvil o Binance.",
    ...
    "pricing.chatgpt.benefit1": "ChatGPT completo, la versión más avanzada",
    "pricing.chatgpt.benefit2": "Genera imágenes ilimitadas con IA",
    "pricing.chatgpt.benefit3": "Analiza documentos y hace investigaciones",
    "pricing.chatgpt.benefit4": "Memoria y asistentes personalizados",
    "pricing.aiultra.benefit1": "Crea videos virales con IA",
    "pricing.aiultra.benefit2": "Genera imágenes de alta calidad",
    "pricing.aiultra.benefit3": "Ideal para TikTok, Reels e historias",
    "pricing.aiultra.benefit4": "Animaciones y efectos profesionales",
    ...
    // Testimonials
    "testimonials.title": "Lo que dicen quienes ya usan",
    "testimonials.titleHighlight": "Jall AI",
    "testimonials.subtitle": "Personas reales que ya están creando contenido increíble con nuestras herramientas.",
    ...
    "testimonials.quote1": "Nunca imaginé hacer videos tan buenos desde mi teléfono. Mi TikTok pasó de 500 a 50K seguidores en 2 meses usando Jall AI.",
    "testimonials.quote2": "Lo mejor es que puedo pagar en bolívares. Sin complicaciones con tarjetas internacionales. Uso ChatGPT todos los días para mi negocio.",
    "testimonials.quote3": "Las voces que genera son increíbles. Mis clientes piensan que contrato locutores profesionales y no se lo creen cuando les digo que es inteligencia artificial.",
    "testimonials.quote4": "Antes pagaba $20 al mes y no usaba ni la mitad. Ahora pago $0.30 el día que lo necesito. Ha sido un cambio total para mi canal.",
    ...
    "dashboard.textToolsNav": "IA Generativa",
    "dashboard.textToolsTitle": "IA Generativa",
    ...
    "dashboard.fullAccessTextTools": "Tienes acceso activo a herramientas de texto. Elige si quieres ingresar a ChatGPT o Grok.",
    "dashboard.openChatGPT": "Abrir ChatGPT Plus",
    "dashboard.openGrok": "Abrir Grok",
    "dashboard.openPerplexity": "Abrir Perplexity",
    "dashboard.openGemini": "Abrir Gemini",
    ...
    "dashboard.activateTextToolsAccess": "¿Activar herramientas de texto por $0.30?",
  ...
  en: {
    ...
    "hero.badge.freePoints": "150 free points",
    "hero.title": "Text, images, videos & AI voices from",
    "hero.pricePerDay": "$0.3/day",
    "hero.subtitle": "Use ChatGPT, generate videos with AI, and create professional voices.",
    "hero.payInBs": "Pay in Bs.",
    "hero.payInUsd": "Pay only for what you use.",
    "hero.createVideos": "Sign up free and try it now.",
    "hero.registerFree": "Get Started Free",
    ...
    // Benefits
    "benefits.title": "Everything you can do with",
    "benefits.titleHighlight": "Jall AI",
    "benefits.subtitle": "Professional AI tools, easy to use from any device.",
    "benefits.chatgpt.title": "Write & ask with ChatGPT",
    "benefits.chatgpt.desc": "Create texts, answer questions, analyze documents, generate images and more. Like having a personal assistant available 24/7.",
    "benefits.video.title": "Create videos with AI",
    "benefits.video.desc": "Generate eye-catching videos in seconds, perfect for social media like TikTok, Instagram and YouTube.",
    "benefits.voice.title": "Generate professional voices",
    "benefits.voice.desc": "Turn any text into a realistic voice. Perfect for videos, presentations and professional content.",
    "benefits.payment.title": "Easy payments in Bs.",
    "benefits.payment.titleGlobal": "Easy & secure payments",
    "benefits.payment.desc": "No international card needed. Pay easily by transfer, mobile payment or Binance.",
    "benefits.payment.descGlobal": "Accepts Binance Pay, cryptocurrencies, and credit/debit cards. Fast and secure.",
    ...
    "pricing.chatgpt.benefit1": "Full ChatGPT, the most advanced version",
    "pricing.chatgpt.benefit2": "Generate unlimited AI images",
    "pricing.chatgpt.benefit3": "Analyze documents and research",
    "pricing.chatgpt.benefit4": "Memory and custom assistants",
    "pricing.aiultra.benefit1": "Create viral AI videos",
    "pricing.aiultra.benefit2": "Generate high quality images",
    "pricing.aiultra.benefit3": "Ideal for TikTok, Reels and stories",
    "pricing.aiultra.benefit4": "Professional animations and effects",
    ...
    // Testimonials
    "testimonials.title": "What people using",
    "testimonials.titleHighlight": "Jall AI say",
    "testimonials.subtitle": "Real people who are already creating amazing content with our tools.",
    "testimonials.role.creator": "Content Creator",
    "testimonials.role.entrepreneur": "Digital Entrepreneur",
    "testimonials.role.cm": "Community Manager",
    "testimonials.role.youtuber": "YouTuber",
    "testimonials.quote1": "I never imagined making such good videos from my phone. My TikTok went from 500 to 50K followers in 2 months using Jall AI.",
    "testimonials.quote2": "The best part is I can pay in bolivars. No complications with international cards. I use ChatGPT every day for my business.",
    "testimonials.quote3": "The voices it generates are incredible. My clients think I hire professional voice actors and don't believe me when I tell them it's artificial intelligence.",
    "testimonials.quote4": "I used to pay $20 a month and didn't even use half of it. Now I pay $0.30 the day I need it. It's been a total game changer for my channel.",
    ...
    "dashboard.home": "Home",
    "dashboard.textToolsNav": "Generative AI",
    "dashboard.textToolsTitle": "Generative AI",
    ...
    "dashboard.fullAccessTextTools": "You have active access to text tools. Choose ChatGPT or Grok to continue.",
    "dashboard.openChatGPT": "Open ChatGPT Plus",
    "dashboard.openGrok": "Open Grok",
    "dashboard.openPerplexity": "Open Perplexity",
    "dashboard.openGemini": "Open Gemini",
    ...
    "dashboard.activateTextToolsAccess": "Activate text tools access for $0.30?",
