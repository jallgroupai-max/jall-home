...
export const accountsService = {
  ...
  async validateAccess(
    ...
    return apiService.post<ValidateAccessResponse>(
      "/user-accounts/validate-access",
      data,
      token,
    );
  },
  ...
  async generateToken(
    ...
    return apiService.post<GenerateTokenResponse>(
      "/user-accounts/generate-token",
      data,
      token,
    );
  },
  ...
  /**
   * Genera un token temporal para que un invitado entre a una cuenta disponible
   */
  async generateGuestToken(
    data: GenerateGuestTokenRequest,
    token: string,
  ): Promise<GenerateTokenResponse> {
    return apiService.post<GenerateTokenResponse>(
      "/user-accounts/guest/generate-token",
      data,
      token,
    );
  },
  ...
  async getAvailableAccounts(
    ...
    return apiService.get<Account[]>(
      `/user-accounts/available?providerId=${providerId}`,
      token,
    );
  },
  ...
  async deactivateAccount(
    ...
    return apiService.delete<{ message: string }>(
      `/user-accounts/${userId}/${accountId}`,
      token,
    );
  },
};
